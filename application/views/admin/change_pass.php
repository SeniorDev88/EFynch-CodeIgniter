...
<div class="page-container login-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <!-- Simple login form -->
                <form action="<?php echo base_url('admin/login/change_password');?>" method="post">
                    <div class="panel panel-body login-form">
                        <div class="text-center">
                            <strong class="login-logo">
								<a href="#"><img src="https://efynch.com/img/logo.png" alt=""></a>
							</strong>
                            <h5 class="content-group">Change Password <small class="display-block">Enter information below</small></h5>
                        </div>
						<div class="form-group has-feedback has-feedback-left">
                            <input type="text" class="form-control" required placeholder="Username" name="email">
                            <div class="form-control-feedback">
                                <i class="icon-user text-muted"></i>
                            </div>
                        </div>
                        <div class="form-group has-feedback has-feedback-left">
                            <input type="password" class="form-control" required name="pre_password" placeholder="Old Password">
                            <div class="form-control-feedback">
                        ...
                        <p class="font-color"><a href="<?php echo base_url(); ?>admin/">Login Here</a></p>
                        <!--<div class="text-center">
