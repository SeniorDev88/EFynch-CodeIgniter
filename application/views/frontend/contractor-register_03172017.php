...
<?php if(isset($error)){ ?><div class="error"><?php echo $errormsg; ?></div><?php } ?>
        ...
        <div class="row contclas" id="step1">
            ...
            <div class="col-sm-8 col-md-4 FN m0auto mt30"><input class="submit100-login radius30p" type="button" value="Next" onclick="showstep(2,'fwd')" /></div>
        </div>
         ...
         <div class="row contclas" id="step2" style="display:none;">
            ...
            <div class="col-sm-12 col-md-10 col-lg-8 FN m0auto clearfix">
                <div class="col-sm-8 col-md-4 FN m0auto mt30"> <button type="button" class="submit100-login radius30p skipit" onclick="showstep(3,'fwd')">Next</button>  </div>
            </div>
        ...
        <div class="row contclas" id="step3" style="display:none;">
            ...
            <div class="col-xs-12 mt10 clearfix">
              <div class="acceptbox">
                ...
                <a href="<?php echo base_url('termsandcondition'); ?>" target="_blank" class="term_accept">Accept <span>Terms and Conditions</span></a>
              </div>
             </div>
             <div class="clear"></div>
            <div class="col-sm-8 col-md-4 FN m0auto mt30"><input class="submit100-login radius30p" type="submit" value="Register" /></div>
