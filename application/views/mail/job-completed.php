...
<table width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#d2d7d5" style="margin:0 auto;">
 ...
 <tr>
    ...
    <td style="border-left:#e4e2e2 1px solid;border-right:#e4e2e2 1px solid;">
     <table cellspacing="0" cellpadding="0" border="0">
        ...
        <td valign="center" style="width:350px;height:125px; font-size:25px; font-weight:bold; color:#f79724;" >Job Completed</td>
        </tr>
     </table>
    </td>
 ...
 <tr>
   ...
   Congratulations! Your Job is marked as completed. 
  <br>
   <a href="<?php echo base_url('view-rating/'.$jobkey.'/'.$userkey)?>">click here</a> to view the Public Rating and <a href="<?php echo base_url('view-rating/'.$jobkey.'/'.$userkey.'?type=private')?>">click here</a> to view the Private Rating.
   </td>
   <td style="width:20px"></td>
 </tr>
