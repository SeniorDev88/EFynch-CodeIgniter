...
<title>Mail Template | Email Verification</title>
</head>
...
<table width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#d2d7d5" style="margin:0 auto;">
 ...
 <tr>
    ...
    <td style="border-left:#e4e2e2 1px solid; border-right:#e4e2e2 1px solid;">
     <table cellspacing="0" cellpadding="0" border="0" bgcolor="#fff">
        ...
        <td valign="center" style="width:183px; height:125px; font-size:25px; font-weight:bold; color:#f79724;" >Email Verification</td>
        </tr>
     </table>
    </td>
 ...
 <tr>
   ...
   <p style="font-size:15px;color:#747373;padding:5px 20px;">Hello <span style="color:#474747;"> <b><?php echo $firstname." ".$lastname;?>,</b></span></p>

   <p style="line-height:24px;font-size:15px;color:#747373; padding:5px 20px 0px 20px;">
    <b>Welcome To Efynch.</b><br />
   Your email verification details are provided below. </p>
