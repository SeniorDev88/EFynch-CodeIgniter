...
<table width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#333" style="margin:0 auto;">
 ...
 <tr>
    ...
    <td style="border-left:#e4e2e2 1px solid;border-right:#e4e2e2 1px solid; background:#fff; border-bottom:1px solid #e4e2e2;">
     <table cellspacing="0" cellpadding="0" border="0">
        ...
        <td style="width:183px;height:125px; font-size:25px; font-weight:bold; color:#f79724;" >Registration</td>
        </tr>
     </table>
    </td>
 ...
 <tr>
   ...
   <p style="font-size:15px;color:#747373;padding:10px 20px;">Hello <span style="color:#474747;"> <b>Administrator,</b></span></p>

   <p style="line-height:24px;font-size:15px;color:#747373; padding:5px 20px 0px 20px;">
   <b>A new <?php echo $usertype; ?> has been registered in efynch.com. <br />
  </p>
   </td>
   <td style="width:20px"></td>
 </tr>
 ...
 <tr>
    ...
    <table style="background:#f8f7f7; width:100%; height:45px;">
      <tr>
      	<td style="height:45px; width:158px; padding-left:35px;"> <p style="color:#5d5d5d; font-size:14px;"><b>Name</b></p></td>
        <td style="height:45px; width:502px; padding-left:20px;"> <p style="color:#5d5d5d; font-size:14px;"><b><?php echo $name; ?> </b></p></td>
      </tr>
    </table>
    </td>
    <td style="width:20px"></td>
 ...
 <tr>
  <td style="width:20px"></td>
    ...
    <table style="background:#f8f7f7; width:100%; height:45px;">
      <tr>
        <td style="height:45px; width:158px; padding-left:35px;"> <p style="color:#5d5d5d; font-size:14px;"><b>Address</b></p></td>
        <td style="height:45px; width:502px; padding-left:20px;"> <p style="color:#5d5d5d; font-size:14px;"><b><?php echo $address; ?></b></p></td>
      </tr>
    </table>
    </td>
    <td style="width:20px"></td>
 ...
 <tr>
    ...
    <table style="background:#f8f7f7; width:100%; height:45px;">
      <tr>
        ...
        <td style="height:45px; width:502px; padding-left:20px;"> <p style="color:#5d5d5d; font-size:14px;"><b><?php echo $useremail; ?></b></p></td>
      </tr>
    </table>
    </td>
    <td style="width:20px"></td>
 ...
 <tr>
  ...
  <td style="width:20px"></td>
    ...
    <table style="background:#f8f7f7; width:100%; height:45px;">
      <tr>
        <td style="height:45px; width:158px; padding-left:35px;"> <p style="color:#5d5d5d; font-size:14px;"><b>Type</b></p></td>
        <td style="height:45px; width:502px; padding-left:20px;"> <p style="color:#5d5d5d; font-size:14px;"><b><?php echo ucfirst ( $usertype); ?> </b></p></td>
      </tr>
    </table>
    </td>
    <td style="width:20px"></td>
