 ...
 <tr>
   ...
   <p style="font-size:15px;color:#747373;padding:10px 20px;">Hello <span style="color:#474747;"> <b><?php echo $toname;?>,</b></span></p>
    ...
    <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
      Thanks for posting on <a href="<?=base_url()?>">EFynch.com</a>. We take this portion of EFynch very seriously.
    </p>
    <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
      In the next few days you will start to get bids. Sometimes they come in right away!
    </p>
    <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
      If you think something is off, are not happy with the pricing, or getting several requests for site visits and hard sales pitches- let us know immediately! (it is against our policy).
    </p>
    <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
      We also remind you that we’ve hidden you contact info- so the respondents should never contact your directly or ask you to call them.
    </p>
    <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
      Keep us posted on the progress and let us know what we can do to help.
    </p>
   </td>
   <td style="width:20px"></td>
 </tr>
