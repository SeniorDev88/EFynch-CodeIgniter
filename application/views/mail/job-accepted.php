...
<title>Mail Template | Registration Completed</title>
</head>
...
<table width="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#d2d7d5" style="margin:0 auto;">
 ...
 <tr>
    ...
    <td style="border-left:#e4e2e2 1px solid;border-right:#e4e2e2 1px solid;">
     <table cellspacing="0" cellpadding="0" border="0">
        ...
        <td valign="center" style="width:350px;height:125px; font-size:25px; font-weight:bold; color:#f79724;" >Job Accepted</td>
        </tr>
     </table>
    </td>
 ...
 <tr>
   ...
   You did it. You were hired for a job and now we can get to work.</p>
   <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
   As you accept the contract, make sure your banking information and address are accurate. This is very important to get paid. If you have a problem with this- let us know right away so we can remedy it.</p>
   <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
   Keep us posted of the progress and when you are done- take a picture- send it in- post it online! We love that stuff!</p>
   <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
   Make sure you keep in regular communication with the homeowner. Customer Service is our #1 priority and as long as you keep them up to date- we think most problems can be avoided.</p>
   <p style="line-height:24px;font-size:15px;color:#747373; padding:10px 20px 0px 20px;">
 ...
 <tr>
    ...
    <td style=" height:80px; width:660px; background:#ffffff; border-left:#e4e2e2 1px solid; border-right:#e4e2e2 1px solid; padding:0 15px;">
      <p style="line-height:24px;font-size:14px;color:#747373; padding-left:20px"> <span style="font-size:16px;">The Efynch Team.</span></p>
     </td>
     <td style="width:20px"></td>
 </tr>
