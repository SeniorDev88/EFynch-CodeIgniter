...
$urlval = "https://loanverify.com/";
?><!DOCTYPE html>
<html lang="en">
<head>
<link href="<?php echo $urlval ;?>styles/reset.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $urlval ;?>styles/bootstrap.css" rel="stylesheet" type="text/css" />
<meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-xs-5 col-sm-3">
              <div class="logosection">
                  <a href="<?php echo $urlval ;?>"><img src="<?php echo $urlval ;?>images/logoimg.png" class="logoimg"></a>
              </div>
            </div>
        </div>
    </div>
    ...
    <div class="container"> 
        <div class="row">
            <div class="col-xs-12">
              ...
              <p class="copyrt tc m0">&copy; <? echo date('Y'); ?> loanverify.com, All Rights Reserved.</p>
