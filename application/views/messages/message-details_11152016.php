...
function upFile(file1) {
    ...
    var username = '<?php echo $this->session->userdata("userFirstname")." ".$this->session->userdata("userLastname"); ?>';
              ...
              <div class="mesg-show"><i></i></div>
            	<div class="newbg divheight pb10">
                    ...
                    if(!empty($messages)){
                        ...
                        ?>
                        <div class="message-details clearfix <?php if($mes['iscurrentuser'] == '1'){ ?>message-right<? }else{ ?>message-left<?php } ?>">
