  ...
  <div class="recent-activity divheight pb10">
    ...
    <?php if($showbidnow == "1"): ?>
        <?php if( !empty( $bidDets ) ): ?>
          ...
          <div class="col-sm-12 FN m0auto mt30">
	...
	<div class="col-xs-12 col-sm-12 col-md-6 pl0 pr0 jobinfo">
      ...
      foreach( $allUsers as $au => $ua ): ?>
				<div class="award-work-wrap clearfix usercls <?php if( $ua['isshortlisted'] == 1 ): ?>usercls_short<?php endif; ?> " id="userbid_<?php echo $ua['bidkey']; ?>">
					<div class="col-xs-8 pl5" data-toggle="modal" data-target="#contractordetails" onclick="showbidinfo('<?php echo $ua['bidkey']; ?>')">
						<a class="profile-img-sm radius50"><img src="<?php echo $ua['imageurl']; ?>"> </a><h2><?php echo $ua['firstname']." ".$ua['lastname'][0]; ?> </h2>
            <p class="icons-lpd zip"><?php echo $ua['city']; if($ua['state'] !="" or $ua['zip'] != ""){ ?>,<?php } ?> <?php echo $ua['state']; ?> <?php echo $ua['zip']; ?></p>
					...
					<div class="col-xs-4 p0-xs">
						<a href="<?php echo base_url('messages/'.$jobDets['jobkey'].'/'.$ua['userkey']); ?>"><i data-toggle="tooltip" data-placement="top" title="Message" class="icon-msghim"></i></a>
						<i data-toggle="tooltip" data-placement="top" title="Shortlist" onclick="shorListJob('<?php echo $ua['bidkey']; ?>')" id="fav_<?php echo $ua['bidkey']; ?>" class="icon-shorlist <?php if( $ua['isshortlisted'] == 1 ): ?>active<?php endif; ?>"></i>  </div>
